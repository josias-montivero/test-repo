...
public class DiscordWebhooks : BattleBitModule
{
    ...
    {
        this.Server.RoundSettings.PlayersToStart = 235;

        if (this.Server.RoundSettings.State == GameState.WaitingForPlayers)
        {
            //this.Server.RoundSettings.PlayersToStart = 230;
    ...
    private async Task UpdatePlayersTeams()
    {
        do
        {
            try
